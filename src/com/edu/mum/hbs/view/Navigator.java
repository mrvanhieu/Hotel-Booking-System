...
public class Navigator {
	...
	public static final String RPT_REVENUE_INFO = "ReportRevenueForm.fxml";
	...
	public static void loadScene(String fxml) {
		...
		try {
			mainController.setLibraryInternalScene(FXMLLoader.load(Navigator.class.getResource(fxml)));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
